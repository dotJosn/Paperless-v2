...
import { Play, Eye, User, Calendar, Timer, Loader2, Activity } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Programas que estão sendo executados atualmente • Total: {programs.length}
              </p>
            </div>
            <Badge variant="secondary" className="bg-blue-100 text-blue-800 text-lg px-4 py-2">
              {programs.length} Em Execução
            </Badge>
          </div>
          ...
          {programs.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">Nenhum programa em execução</h3>
                <p className="text-muted-foreground text-center">Não há programas sendo executados no momento.</p>
              </CardContent>
            </Card>
          ) : (
